#Library/functionality  improrts 
import sensor
import image
import lcd
import KPU as kpu
...
#function to start person detection aquisition
def set_key_state(*_):
...
#start kpu coprocessign for YOLO algorithm
...
while (1):
    ...
    # kpu.memtest()
#in case of memory problems enable options between usage 
